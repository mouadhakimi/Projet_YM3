...
<html lang="fr">
    ...
    <body >
        ...
        <div class="container-fluid">
            <div class="warning">
            <form action="traitement_ajout_filiére.php" method="post">
                    <h4>Ajouter filiére : </h4><br>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Nom filiére :</span>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Definition :</span>
                        <textarea name="definition" class="md-textarea form-control" required></textarea><br>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Salaire :</span>
                        <textarea name="salaire" class="md-textarea form-control" required></textarea><br>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Formation :</span>
                        <textarea name="formation" class="md-textarea form-control" required></textarea><br>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Principaux employeurs :</span>
                        <textarea name="principaux_employeurs" class="md-textarea form-control" required></textarea><br>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Qualites et competences necessaires :</span>
                        <textarea name="qualites_competences_necessaires" class="md-textarea form-control" required></textarea><br>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Lien :</span>
                        <input type="text" name="lien" class="form-control" required><br>
                    </div>
